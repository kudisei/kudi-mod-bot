...
client.on("message", message => {
    ...
    return message.channel.send(`427`)
});
...
client.on("message", message => {
    ...
    return message.channel.send(` Yursula Sunucusuna Geldiginden Beri Çok Mutluyum Teşekkürler kudi :heart: :heart:`)
});
...
db.delete(`muteli_${member.guild.id + member.id}`)
    ...
    member.roles.remove('853438537465856014');
  }, ms(süre));
}
})
